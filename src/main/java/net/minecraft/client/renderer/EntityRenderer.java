...
import dev.gothaj.events.events.Event3D;
import dev.gothaj.events.events.EventRayTrace;
import dev.gothaj.events.events.EventRotation;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks) {
        Entity entity;
        if ((entity = this.mc.getRenderViewEntity()) != null && this.mc.theWorld != null) {
            EventRayTrace event = (EventRayTrace)new EventRayTrace(3.0f, this.mc.playerController.getBlockReachDistance());
            Client.INSTANCE.getEventBus().fire(event);
            this.mc.mcProfiler.startSection("pick");
            this.mc.pointedEntity = null;
            double d0 = event.getBlockRange();
            ...
            if (this.mc.playerController.extendedReach()) {
                d0 = 6.0;
                d1 = 6.0;
            } else if (d0 > (double)event.getRange()) {
                flag = true;
            }
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > (double)event.getRange()) {
                this.pointedEntity = null;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Client.INSTANCE.getEventBus().fire(event3D);
