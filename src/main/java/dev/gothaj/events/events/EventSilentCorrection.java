...
public class EventSilentCorrection extends Event {

    float moveForward;
    float moveStrafe;
    float yaw;
    float shouldYaw;
    boolean silentMoveFix;
    boolean fixYaw;
    boolean sneak;
    ...
    public EventSilentCorrection(float moveForward, float moveStrafe, float yaw, float shouldYaw, boolean silentMoveFix, boolean fixYaw, boolean sneak) {
        this.moveForward = moveForward;
        this.moveStrafe = moveStrafe;
        this.yaw = yaw;
        this.shouldYaw = shouldYaw;
